...
|----------|---------|----------|
| `pr.yml` **(active)** | pull_request, push to main | paths-filter + repo hygiene + compose lint + self-enforcing placeholders (java/python/frontend) + aggregate `CI OK` status; real lint/test steps replace placeholders as components are scaffolded |
