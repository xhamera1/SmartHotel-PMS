...
class AuthApiIT {
    ...
    void loginRefreshAndRoleGuards() {
        ...
        // Public availability stays open
        ...
        // Receptionist cannot manage room types (ADMIN only)
        ...
        // Refresh token cannot call admin API
        ...
        // Sanity: admin can create a room type
